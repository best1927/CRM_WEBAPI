...
<DataContract(),Table("CRM_UNFOLLOW_TRN")> _
Public Class CrmUnfollowTrn
    Inherits BaseDto
    Implements IEquatable(Of CrmUnfollowTrn)
...
Private _UserId As String
	...
	Private _ContactId As Nullable(of Decimal)
		<DataMember(),DataField("CONTACT_ID")> _
		Public Property ContactId() As Nullable(of Decimal)
			Get
				Return Me._ContactId
			End Get
			Set(ByVal value As Nullable(of Decimal))
					If (Object.Equals(Me.ContactId, value) <> true) Then				    
						Me._ContactId = value
...
Private _ActivityCat As String
        ...
        Public Function Equals1(ByVal other As CrmUnfollowTrn) As Boolean Implements System.IEquatable(Of CrmUnfollowTrn).Equals
...
if Me.UserId <> other.UserId Then
        ...
        End Function
         ...
         Public Overrides Function GetHashCode() As Integer
            Return GetHashValue(AId) Xor GetHashValue(UserId)
        End Function
