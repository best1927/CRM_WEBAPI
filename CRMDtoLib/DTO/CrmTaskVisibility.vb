...
<DataContract(),Table("CRM_TASK_VISIBILITY")> _
Public Class CrmTaskVisibility
    Inherits BaseDto
    Implements IEquatable(Of CrmTaskVisibility)
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmTaskVisibility) As Boolean Implements System.IEquatable(Of CrmTaskVisibility).Equals
