...
<DataContract(),Table("MAS_LANGUAGE")> _
Public Class MasLanguage
    Inherits BaseDto
    Implements IEquatable(Of MasLanguage)
...
Private _CultureInfo As String
		<DataMember(),DataField("CULTURE_INFO")> _
		Public Property CultureInfo() As String
			Get
				Return Me._CultureInfo
			End Get
			Set(ByVal value As String)
					If (Object.ReferenceEquals(Me.CultureInfo, value) <> true) Then				    
...
Private _LastFunction As String
        ...
        Public Function Equals1(ByVal other As MasLanguage) As Boolean Implements System.IEquatable(Of MasLanguage).Equals
        ...
        End Function
         ...
         Public Overrides Function GetHashCode() As Integer
            Return GetHashValue(LanguageCode)
        End Function
