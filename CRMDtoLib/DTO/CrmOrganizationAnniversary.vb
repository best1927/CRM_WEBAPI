...
<DataContract(),Table("CRM_ORGANIZATION_ANNIVERSARY")> _
Public Class CrmOrganizationAnniversary
    Inherits BaseDto
    Implements IEquatable(Of CrmOrganizationAnniversary)
...
Private _CatDate As String
        ...
        Public Function Equals1(ByVal other As CrmOrganizationAnniversary) As Boolean Implements System.IEquatable(Of CrmOrganizationAnniversary).Equals
