...
Private _SendTo As String
		<DataMember(),DataField("SEND_TO")> _
		Public Property SendTo() As String
			Get
				Return Me._SendTo
			End Get
			Set(ByVal value As String)
					If (Object.ReferenceEquals(Me.SendTo, value) <> true) Then				    
						Me._SendTo = value
...
Private _Descr3 As String
		<DataMember(),DataField("DESCR3")> _
		Public Property Descr3() As String
			Get
				Return Me._Descr3
			End Get
			Set(ByVal value As String)
					If (Object.ReferenceEquals(Me.Descr3, value) <> true) Then				    
						Me._Descr3 = value
						OnPropertyChanged("Descr3")
				    End If 
			End Set
		End Property
