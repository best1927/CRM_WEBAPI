...
<DataContract(),Table("CRM_ORGANIZATION_VISIBILITY")> _
Public Class CrmOrganizationVisibility
    Inherits BaseDto
    Implements IEquatable(Of CrmOrganizationVisibility)
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmOrganizationVisibility) As Boolean Implements System.IEquatable(Of CrmOrganizationVisibility).Equals
