...
<DataContract(),Table("CRM_EMAIL")> _
Public Class CrmEmail
    Inherits BaseDto
    Implements IEquatable(Of CrmEmail)
...
Private _OwnerId As String
		...
		Public Property OwnerId() As String
			...
			End Get
			Set(ByVal value As String)
					If (Object.ReferenceEquals(Me.OwnerId, value) <> true) Then				    
						Me._OwnerId = value
...
Private _SentFrom As String
		<DataMember(),DataField("SENT_FROM")> _
		Public Property SentFrom() As String
			Get
				Return Me._SentFrom
			End Get
			Set(ByVal value As String)
					If (Object.ReferenceEquals(Me.SentFrom, value) <> true) Then				    
						Me._SentFrom = value
						OnPropertyChanged("SentFrom")
				    End If 
			End Set
		End Property
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmEmail) As Boolean Implements System.IEquatable(Of CrmEmail).Equals
