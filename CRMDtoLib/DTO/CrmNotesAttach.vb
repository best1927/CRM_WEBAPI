...
<DataContract(),Table("CRM_NOTES_ATTACH")> _
Public Class CrmNotesAttach
    Inherits BaseDto
    Implements IEquatable(Of CrmNotesAttach)
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmNotesAttach) As Boolean Implements System.IEquatable(Of CrmNotesAttach).Equals
...
if Me.Seq <> other.Seq Then
        ...
        End Function
         ...
         Public Overrides Function GetHashCode() As Integer
            Return GetHashValue(NoteId) Xor GetHashValue(Seq)
        End Function
