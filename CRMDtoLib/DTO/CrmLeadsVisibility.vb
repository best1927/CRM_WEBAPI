...
<DataContract(),Table("CRM_LEADS_VISIBILITY")> _
Public Class CrmLeadsVisibility
    Inherits BaseDto
    Implements IEquatable(Of CrmLeadsVisibility)
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmLeadsVisibility) As Boolean Implements System.IEquatable(Of CrmLeadsVisibility).Equals
...
if Me.Seq <> other.Seq Then
        ...
        End Function
         ...
         Public Overrides Function GetHashCode() As Integer
            Return GetHashValue(LeadId) Xor GetHashValue(Seq)
        End Function
