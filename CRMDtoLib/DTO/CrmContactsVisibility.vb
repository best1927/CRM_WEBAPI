...
<DataContract(),Table("CRM_CONTACTS_VISIBILITY")> _
Public Class CrmContactsVisibility
    Inherits BaseDto
    Implements IEquatable(Of CrmContactsVisibility)
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmContactsVisibility) As Boolean Implements System.IEquatable(Of CrmContactsVisibility).Equals
