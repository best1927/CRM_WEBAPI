...
<DataContract(),Table("CRM_OPPORTUNITY_VISIBILITY")> _
Public Class CrmOpportunityVisibility
    Inherits BaseDto
    Implements IEquatable(Of CrmOpportunityVisibility)
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmOpportunityVisibility) As Boolean Implements System.IEquatable(Of CrmOpportunityVisibility).Equals
...
if Me.Seq <> other.Seq Then
        ...
        End Function
         ...
         Public Overrides Function GetHashCode() As Integer
            Return GetHashValue(OppuId) Xor GetHashValue(Seq)
        End Function
