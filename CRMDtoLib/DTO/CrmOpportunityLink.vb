...
<DataContract(),Table("CRM_OPPORTUNITY_LINK")> _
Public Class CrmOpportunityLink
    Inherits BaseDto
    Implements IEquatable(Of CrmOpportunityLink)
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmOpportunityLink) As Boolean Implements System.IEquatable(Of CrmOpportunityLink).Equals
