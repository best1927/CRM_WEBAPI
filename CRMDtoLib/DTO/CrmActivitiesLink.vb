...
Private _RelateCd As String
		<DataMember(),DataField("RELATE_CD")> _
		Public Property RelateCd() As String
			Get
				Return Me._RelateCd
			End Get
			Set(ByVal value As String)
					If (Object.ReferenceEquals(Me.RelateCd, value) <> true) Then				    
						Me._RelateCd = value
						OnPropertyChanged("RelateCd")
				    End If 
			End Set
		End Property
