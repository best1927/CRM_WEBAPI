...
<DataContract(),Table("CRM_FILES")> _
Public Class CrmFiles
    Inherits BaseDto
    Implements IEquatable(Of CrmFiles)
         
	 
   	Private _FileId As Decimal
		<DataMember(),DataField("FILE_ID"),DataAnnotations.Key()> _
		Public Property FileId() As Decimal
			Get
				Return Me._FileId
			End Get
			Set(ByVal value As Decimal)
					If (Object.ReferenceEquals(Me.FileId, value) <> true) Then
						Me._FileId = value
...
Private _Programcode As String
        ...
        Public Function Equals1(ByVal other As CrmFiles) As Boolean Implements System.IEquatable(Of CrmFiles).Equals
           
           if Me.FileId <> other.FileId Then
                Return False
            End If
